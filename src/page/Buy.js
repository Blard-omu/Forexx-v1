            ...
            <div className='container pt-5'>
                <div className='instant-box mt-3 d-block m-auto p-5'>
                    ...
                    <div className='mt-4 btn-all'>
                        <button className='buy-button btn btn-sm buy-sell'>
                            <Link to='/Buy' className='text-decoration-none text-dark'>Buy</Link>
                        </button>
                        <button className='sell-button btn btn-sm buy-sell'>
                    ...
                    <div className='mt-4' >
                        <form action="">
                            <div>
                                <label for="inputState" class="form-label text-start"><b>Choose Currency to Buy</b></label>
                            ...
                            <div className='mt-5'>
                                ...
                                <input type="text" class="form-control" id="autoSizingInputGroup" placeholder="3,000,000"/>
                                </div>
                            </div>
                        </form>

                        <div className='mt-5'>
                            <button className='btn btn-secondary buy-btn2 bg-two'>Continue</button>
                        </div>
                    </div>
                </div>
            </div>
